...
def add_game(name, path, code, conn):
    cur = conn.cursor()
...
def list_game_users(game_id, conn):
    cur = conn.cursor()
...
def add_user(login, password, conn):
    cur = conn.cursor()
...
def compare_passw(login, password, conn):
    cur = conn.cursor()
...
def add_player(user_id, quality, player_id, game_id, conn):
    cur = conn.cursor()
...
def change_player_qual(user_id, game_id, quality, conn):
    cur = conn.cursor()
...
def rm_player(user_id, game_id, conn):
    cur = conn.cursor()
